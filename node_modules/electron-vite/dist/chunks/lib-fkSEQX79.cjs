...
function loadPackageData(root = process.cwd()) {
    ...
    if (fs.existsSync(pkg)) {
        const _require = node_module.createRequire((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.src || new URL('chunks/lib-fkSEQX79.cjs', document.baseURI).href)));
...
const _require$1 = node_module.createRequire((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.src || new URL('chunks/lib-fkSEQX79.cjs', document.baseURI).href)));
